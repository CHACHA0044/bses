        ...
        <div className="page-container relative z-10 grid grid-cols-1 gap-12 py-16 lg:grid-cols-12 lg:gap-8 lg:py-24 items-center">
          ...
          >
            <span className="inline-flex items-center gap-2 rounded-full border border-amber-400/30 bg-amber-500/15 px-4 py-1.5 text-xs font-bold text-amber-300">
              ...
              Official BSES Delhi Discom Portal — BRPL &amp; BYPL
            </span>
              ...
              {journeySteps.map((step, i) => {
                ...
                return (
                  <motion.div
                    ...
                    className="group relative flex flex-col justify-between rounded-3xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-xl hover:border-primary/40 hover:z-30 transition-all duration-300"
                  >
                    ...
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className={`p-3 rounded-2xl ${step.accent} shadow-md group-hover:scale-110 transition-transform duration-300`}>
                        <Icon className="h-5 w-5" />
                      </div>
                    </div>
                    ...
                    {/* Flow Arrow Connector between desktop cards — cleanly placed in gap */}
                    {i < journeySteps.length - 1 && (
                      <div className="hidden lg:flex absolute -right-5 xl:-right-6 top-1/2 -translate-y-1/2 z-20 items-center justify-center h-9 w-9 rounded-full bg-white border border-slate-200 shadow-md text-slate-400 group-hover:border-primary group-hover:text-primary group-hover:scale-110 transition-all duration-300 pointer-events-none">
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="flex w-full items-center justify-between gap-4 p-5 sm:p-6 text-left font-bold text-slate-900 focus:outline-none"
