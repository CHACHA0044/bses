                ...
                <tr key={u.id} className="hover:bg-slate-50 transition">
                  ...
                  <td className="p-3 text-right">
                    <PrefetchLink
                      ...
                      dataUrls={[`/admin/users/${u.id}`]}
                      className="inline-flex items-center gap-1 bg-slate-100 text-slate-700 hover:bg-slate-200 font-bold text-xs px-3 py-1.5 rounded-lg transition"
                    >
                      View Detail
                    </PrefetchLink>
                  </td>
